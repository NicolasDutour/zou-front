...
import { TypeFormSchemaContact, FormSchemaContact } from '@/lib/validations';
      ...
      <div className="space-y-6">
        ...
        <div className='w-1/3'>
          <button
            type='submit'
            disabled={isLoading}
            className="flex w-full justify-center rounded-md bg-blueDark px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blueDark disabled:opacity-40"
          >
            {
              isLoading ? (
                <LoaderButton />

...
import { addSpaceToPhoneNumber, capitalize } from '@/lib/utils';
...
export default function RestaurantBanner({ restaurant }: { restaurant: RestaurantType }) {
  ...
  return (
    <section className="w-full">
      <div className="relative p-10 bg-cover bg-center h-full bg-hero-pattern flex justify-center items-center">

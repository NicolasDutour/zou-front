    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="mb-8 mt-4">
          ...
          <button
            className="mt-4 flex w-1/2 justify-center rounded-md bg-blueDarker px-3 py-1.5 text-sm font-medium leading-6 text-white shadow-sm hover:bg-blueDark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blueDarker"
          >
            Valider
          </button>
        </div>

...
export const OptionsCard = () => {
  return (
    <Card className="flex flex-col justify-between border-2 border-yellow-400 p-2">
      ...
      <CardContent className="p-4 text-blueDarker">
      ...
      <CardFooter className="justify-center">
        <p className="text-4xl text-blueDark"> {formatCurrency(2)}<span className="ml-2 text-2xl text-gray-500">/ produit</span> </p>
      </CardFooter>
    </Card>
  )
}

  ...
  return (
    <section id="faqs" className="bg-blueDark p-10">
      <div className="mx-auto grid place-items-center lg:max-w-5xl">
        ...
        <p className="text-xl text-white">Et <span className="text-2xl font-bold italic tracking-widest text-yellow underline underline-offset-4"> Zou</span> votre site est en ligne ! </p>
        {
          !token ? (
            <div>
              <div className="mt-4 flex items-center justify-center gap-4">
                <Link
                  href="/register"
                  className="flex w-1/2 justify-center rounded-md bg-yellow p-2 text-lg font-medium text-blueDark"
                >
                  Je me lance
                </Link>
              </div>

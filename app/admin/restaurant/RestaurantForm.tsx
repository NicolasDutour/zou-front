        ...
        return (
          <div className="">
            <div className="relative border rounded-md h-56">
              <Image
                src={user?.restaurants[0]?.banner_photo ? environment === "production" ? "https://res.cloudinary.com/dwfjprl6o/image/upload/v1704981278/reine_e17548c92e.jpg" : `${process.env.NEXT_PUBLIC_STRAPI_URL}${user?.restaurants[0]?.banner_photo.url}` : ""}
